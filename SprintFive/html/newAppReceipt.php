    ...
    <nav id="navbarTarget"></nav>
      ...
      <div class="container-fluid col-sm-8 col-xs-8 receptContainer mt-3">
        ...
        <?php
            ...
            $followUp = filter_var($_POST['followUp'], FILTER_SANITIZE_STRING);
            ...
            if(isset($_POST["employer"]) && isset($_POST["role"]) )
            {
                ...
                $sql = "insert into Application (employer, title, jobDescriptionURL, jobDescription, date, status, updates, followUpDate, visibility, username) values ('$employer', '$role', '$job', '$description', '$date','$status','$updates' ,'$followUp','1', '$name')";
