...
<div  class="container-fluid col-sm-8 col-xs-8 applicationContainer">
  ...
  <form action="newAppReceipt.php" method="POST">
    <div id="applicationShared" class="rounded-4">

      <label for="employerInput" class="form-label text-start ">Employer Name</label>
      <input type="text" id="employerInput" name="employer" class="form-control">

      <label for="roleInput" class="form-label text-start mt-3">Name of Role</label>
      <input type="text" id="roleInput" name="role" class="form-control">

      <label for="jobInput" class="col-5 mt-3">Job Description URL</label>
      <input type="text" id="jobInput" name="job" class="form-control">

      <label for="descriptionInput" class="form-label text-start mt-3">Job Description</label>
      <textarea id="descriptionInput" name="description" rows="4" cols="50" class="form-control"></textarea>

      <label for="dateInput" class="form-label text-start mt-3"></label>Date of Application</label>
      ...
      <label for="updatesInput" class="form-label text-start mt-3">Updates</label>
      <textarea id="updatesInput" name="updates" rows="4" cols="50" class=" form-control">Who have you spoken with interviewed? Contact info?</textarea>

      <label for="followUpInput" class="form-label text-start mt-3" id="followUpDate">Follow up date</label>
      <input type="date" id="followUpInput" name="followUp">
    </div>
...
<!-- APPLICATION BODY CODE ENDS HERE -->
